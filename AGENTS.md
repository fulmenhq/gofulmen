...
| ----------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Codex CLI         | `AGENTS.md`                                          | `Generated by <agent identity> ([Codex CLI](https://github.com/openai/codex)) under supervision of @3leapsdave`     |
...
for type:link installations, causing goneat to become stale after
source rebuilds. Now properly uses os.Symlink() per filepath best practices.

Verified: goneat now tracks source automatically.
